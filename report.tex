...
\noindent Project repository: \url{https://github.com/Kushal-2002/smai_a3} \\
...
An accuracy of \textbf{82.69\%} on the Bengali test set is a strong result for a low-resource setting. This confirms that the IndicBERT representations, even without any domain-specific pretraining, transfer well to Bengali review sentiment.
...
\midrule
\textbf{Negative} & 68 & 13 \\
\textbf{Positive} & 14 & 61 \\
\bottomrule
\end{tabular}
\end{center}
